...
1. Пакеты: `python3 tools/pack_bhs.py` (BusyHands) и `python3 tools/_pack_kristiano_aio.py` (AIO + три отдельных: `context_menu_overhaul_anthology`, `quickqk_task_complete`, `fix_st2_footstep`). Состав AIO — `SKIP`/`SEPARATE` в скрипте.
