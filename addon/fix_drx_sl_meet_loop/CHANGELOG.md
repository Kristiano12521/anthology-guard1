...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; В MO2 после сборки / WTF (wrap на уже загруженный `xr_effects`) после успешного `give_task`.

**Удаление**

- Отключить слот в MO2; новая игра не нужна.
- Уже записанные honcho/task через save_var остаются (плюс против петли meet). Без фикса снова возможна запись следующего хончо без выданного задания.
