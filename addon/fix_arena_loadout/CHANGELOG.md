...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; В MO2 ниже MAG Redux и Exo System (как раньше) После MT reload xr_effects снова без recover/mags/exo.

**Удаление**

- Отключить слот в MO2; новая игра не нужна.
- Прогресс арены и уже выданное снаряжение в сейве сохраняются. Без обёртки `bar_arena_teleport` следующий заход на арену снова рискует CTD или кривыми магазинами/PSU — возврат бага, не битый сейв.
