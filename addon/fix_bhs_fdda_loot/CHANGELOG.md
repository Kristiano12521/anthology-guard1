...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; нужен FDDA Redone; вместе с BHS.
...
- Только логирование: безусловная presence-строка при загрузке; `printf` с причиной при раннем выходе из `on_game_start`.

**Не затронуто**

- Обёртка `start_body_search`, колбэки.
