...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; В MO2 ниже сборки; ZIP v1 после интро restrictor снова доходит до `@has_item` и выдаёт `actor_has_item_flash`.
...
- CreateTimeEvent recovery, actor_on_item_take.
