...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; В MO2 ниже сборки; ZIP и `[DBG] Kristiano Fixes ALL IN ONE` с теми же путями выключить после перезагрузки.
