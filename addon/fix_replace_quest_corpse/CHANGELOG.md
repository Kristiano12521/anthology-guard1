...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; В MO2 ниже сборки.

**Удаление**

- Не снимайте при активном SGM-задании на труп (Громобой / Касилов / Science Report и т.п.). Сдайте или провалите квест, сохранитесь, затем отключайте.
- Без глобала replace_quest_corpse снова FATAL в sgm_tasks. Уже заспавненные replace_spot/предметы в сейве остаются.
...
- Восстановление `_G.replace_quest_corpse`, колбэки.
