...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; В MO2 ниже сборки; ZIP и копию в `[DBG] Kristiano Fixes ALL IN ONE` выключить После одного успешного ремонта тайника Ильи (лог recovered) сохранитесь, затем отключ.

**Удаление**

- После одного успешного ремонта тайника Ильи (лог recovered) сохранитесь, затем отключайте слот в MO2.
- Починенный active_section остаётся в сейве — плюс. DLTX засады/лута действует только пока мод стоит. Не чинили — без wrap схема тайника снова битая.
