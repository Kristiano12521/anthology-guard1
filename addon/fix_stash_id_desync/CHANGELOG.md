...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; В MO2 как раньше После замены таблицы `treasure_manager` гард `caches[id]==false` снова отваливался.

**Удаление**

- Отключить слот в MO2; новая игра не нужна.
- Уже счищенные битые caches/метки остаются очищенными. Без гарда десинк id тайников может вернуться.
