...
**Требования:** Anomaly 1.5.3 / Anthology 2.1 / Modded Exes MT; В MO2 ниже сборки После MT reload гард `alive()` снова отваливался.
...
- Обёртки rx_bandage, guard-сообщения в `install()`.
