...
- **2026-09-01** · `!ERROR item_combination | wrong section names` · R.A.K 3DSS `mod_craft_magnifiers` (`magnifier` / `e0t2` / `uh2` — слоты прицела, не секции предметов) · починено: `fix_item_combination_magnifiers` (DLTX `!` на четыре строки) · [2026-09-01_xray_nikit-2.md](../logs/cards/2026-09-01_xray_nikit-2.md) · pitfalls — нет · подробности: `addon/fix_item_combination_magnifiers/CHANGELOG.md`
